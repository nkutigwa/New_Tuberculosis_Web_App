...
(async function () {
	...
	model = await tf.loadModel('https://github.com/nkutigwa/New_Tuberculosis_Web_App/blob/main/tfjs_Model/model.json');
	$("#selected-image").attr("src", "https://github.com/nkutigwa/New_Tuberculosis_Web_App/blob/main/assets/tb_image.jpg")
